...
#define WIDTH_OF_CONTENT_VIEW_VISIBLE	125.f//44.f
...
- (void)viewDidLoad
{
    ...
    [self.view setBackgroundColor:[UIColor colorWithPatternImage:[UIImage imageNamed:@"bg_all_menu.png"]]];
...
{
	self.panGesture.enabled =panGestureEnabled;// [Constants enablePanGesture];
}
