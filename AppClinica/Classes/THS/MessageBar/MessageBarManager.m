...
#define kMessageBarDisplayDelay 4.0
...
//    [self showMessageWithTitle:title description:description type:type forDuration:[MessageBarManager durationForMessageType:type] callback:nil];
  ...
  [[[UIAlertView alloc]initWithTitle:NAME_APP message:description delegate:nil cancelButtonTitle:@"Ok" otherButtonTitles:nil, nil]show];
...
- (void)showNextMessage
{
    if ([_messageBarQueue count] > 0){
        ...
        messageView.frame = CGRectMake(0, -([messageView height]+20), [messageView width], [messageView height]+20);
